...
export interface NeonForgeBridge {
  ...
  gateway: {
    ...
    streamChat: (opts: { apiKey: string; level?: string; tools?: boolean; messages: Array<{ role: string; content: string | null; tool_calls?: unknown[]; tool_call_id?: string }> }) => Promise<{ ok: boolean; error?: string }>
