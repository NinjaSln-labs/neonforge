...
describe('isInSandbox（沙箱内外——项目根）', () => {
  const root = '/Users/sin/Projects/game'
  it('项目根自身 = 沙箱内', () => {
    expect(isInSandbox('/Users/sin/Projects/game', root)).toBe(true)
  })
  it('项目根下子路径 = 沙箱内', () => {
    expect(isInSandbox('/Users/sin/Projects/game/src/main.js', root)).toBe(true)
  })
  it('项目根外 = 沙箱外', () => {
    expect(isInSandbox('/Users/sin/Downloads/other.js', root)).toBe(false)
    expect(isInSandbox('/Users/sin/Projects/game2/src/x.js', root)).toBe(false) // 前缀相似但非同一根
  })
