...
> version: v1.2 · 2026-08-16（v1.1 · 2026-08-16；v1 · 2026-07-31）
> 修订（v1.2）：第 16 轮审计 #3——补「执行转化率」指标（方案批准→首次写入——03 §2 衡量落地）
...
| **执行转化率**（2026-08-16 补——第 16 轮审计 #3）| 方案批准后首次写入产出的任务占比（确认后是否真正动手——03 §2「方案批准到产出率」落地）| **≥ 80%** | Beta 起（decision.resolved(kind=plan)→首次 write 埋点）|
